...
class Message {
  ...
  static List<Message> generatedMessageFromUser() {
    return [
      Message(users[2], 'I hate programming😖😖', '10:15 a.m.'),
      Message(me, 'Okay, no problem, chill 😀', '1:10 p.m.'),
      Message(users[2], 'Aj amar mon valo nei 😑', '12:45 a.m.'),
      Message(me, 'You need break', '10:05 a.m.'),
      Message(users[2], 'Khatam, ta ta, bye bye 😮‍💨😪', '9:36 p.m.'),
      Message(me, 'O vai, maro mujhe maro 🤣😂🤣', '11:20 p.m.'),
    ];
  }
}
